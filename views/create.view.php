        ...
        <div class="p-6 bg-white border-b border-gray-200 md:grid md:grid-cols-5 gap-4">
            ...
            <div class="col-span-4">
                <div class="flex justify-between mb-4">
                    <h3 class="mb-4 text-xl font-bold">Add Posts</h3>
                </div>
                <div>
                    <div>
                        <h3>Title</h3>
                        <input type="text" name="myInputBox" placeholder="Username" size="30" maxlength="50" required>
                    </div>
                    <div>
                        <h3>Slug</h3>
                        <input type="text" name="myInputBox" placeholder="Slug" size="30" maxlength="50" required>
                    </div>
                    <div>
                        <h3>Body</h3>
                        <input type="text" name="myInputBox" placeholder="Body" size="30" maxlength="50" required>
                    </div>
                    <div>
                        <h3>Thumbnail</h3>
                        <input type="file" name="myFile" accept="image/*" multiple="true">
                    </div>
                    <div>
                        <button class="bg-blue"  type="button" name="myButton">Save Data</button>
                    </div>
                </div>
            </div>
        </div>
